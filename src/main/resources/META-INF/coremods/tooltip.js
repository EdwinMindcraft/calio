    ...
    return {
        "calio_remove_italic": {
            ...
            'transformer': function (node) {
                ...
                instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, 'dev/experimental/calio/common/util/CoreHelper', 'removeItalic', '(Lnet/minecraft/world/item/ItemStack;Lnet/minecraft/network/chat/Component;)Lnet/minecraft/network/chat/Component;'));
        ...
        "calio_remove_flag": {
            ...
            'transformer': function (node) {
                ...
                //param1 = CoreHelper.removeItalic(this.self(), param1);
                instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
                instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, 'dev/experimental/calio/common/util/CoreHelper', 'removeNonItalicFlag', '(Lnet/minecraft/world/item/ItemStack;)V'));
                node.instructions.insert(instructions);
                return node;
            }
        }
