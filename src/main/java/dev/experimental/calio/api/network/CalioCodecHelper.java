...
public class CalioCodecHelper {
     ...
     * @return A codec for the given {@link RegistryKey}
     */
    public static <T> Codec<RegistryKey<T>> resourceKey(RegistryKey<? extends Registry<T>> registry) {
        return SerializableDataTypes.IDENTIFIER.xmap(x -> RegistryKey.of(registry, x), RegistryKey::getValue);
    }
     ...
     * @see net.minecraft.util.collection.WeightedList#createCodec(Codec) for minecraft's weighted list.
     */
